package io.github.yeahfo.fit.core.common.domain.idnode;

import io.github.yeahfo.fit.core.common.domain.idnode.exception.IdNodeLevelOverflowException;
import io.github.yeahfo.fit.core.common.domain.idnode.exception.IdNodeNotFoundException;
import io.github.yeahfo.fit.core.common.domain.idnode.exception.NodeIdFormatException;
...
public class IdTree {
    ...
    public static class IdNode {
        ...
        private void addChild( String nodeId ) {
            this.children.addFirst( new IdNode( nodeId ) );
        }
